            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Scan Location & User Management</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalLocations}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">{stats.activeLocations} active</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm text-gray-600 dark:text-gray-400">Scan Users</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalScanUsers}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Active scanners</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalScans.toLocaleString()}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">All locations</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm text-gray-600 dark:text-gray-400">Avg Scans/Location</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                                    {stats.totalLocations > 0 ? Math.round(stats.totalScans / stats.totalLocations) : 0}
                                </p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Performance metric</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td colSpan={7} className="px-6 py-12 text-center">
                                                ...
                                                <p className="text-gray-500 dark:text-gray-400">No scan locations found</p>
                                            <button
                                        ...
                                        locations.map((location: ScanLocation) => (
                                            <tr key={location.id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div>
                                                        <div className="text-sm font-medium text-gray-900 dark:text-white">{location.name}</div>
                                                        <div className="text-sm text-gray-500 dark:text-gray-400">{location.description}</div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900 dark:text-white">{location.active_scan_users_count}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900 dark:text-white">{location.total_scans.toLocaleString()}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div>
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    ...
                                    <button
                                        ...
                                        className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white dark:bg-secondary-900 text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                                    >
                                        Cancel
                                    </button>
                                </div>
                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-secondary-900 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                            <div className="bg-white dark:bg-secondary-900 px-4 pt-5 pb-4 sm:p-6">
                                            ...
                                            {usersLoading ? (
                                                ...
                                                <tr>
                                                    <td colSpan={6} className="px-6 py-12 text-center">
                                                        ...
                                                        <p className="text-gray-500 dark:text-gray-400">No scan users found</p>
                                                    </td>
                                                </tr>
                                            ) : (
                                                users.map((user: ScanUser) => (
                                                    <tr key={user.id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <div className="text-sm text-gray-900 dark:text-white">{user.total_scans}</div>
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <div className="text-sm text-gray-900 dark:text-white">
                                                                {user.last_login_at
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button
                                    ...
                                    className="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white dark:bg-secondary-900 text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm"
                                >
                                    Close
                                </button>
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="bg-blue-50 rounded-lg p-4">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                <p className="text-sm text-gray-600 dark:text-gray-400">Total Scans</p>
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{selectedLocation.total_scans.toLocaleString()}</p>
                                            </div>
                </div>
            </div>
                                    ...
                                    <div className="bg-green-50 rounded-lg p-4">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{selectedLocation.active_scan_users_count}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-purple-50 rounded-lg p-4">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                <p className="text-sm text-gray-600 dark:text-gray-400">Max Concurrent</p>
                                                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        <dl className="grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2">
                                            <div>
                                                ...
                                                <dd className="text-sm text-gray-900 dark:text-white">{selectedLocation.description || 'No description'}</dd>
                                            </div>
                                            <div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                            <div className="text-center">
                                                <p className="text-sm text-gray-500 dark:text-gray-400">Avg Scans/User</p>
