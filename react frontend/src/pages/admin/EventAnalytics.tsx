            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6">
                <div className="flex items-center space-x-4 mb-4 lg:mb-0">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">{eventDetails.name || eventDetails.title}</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="lg:w-3/4">
                        <div className="flex items-start justify-between mb-4">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white">{eventDetails.name || eventDetails.title}</h2>
            ...
            <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Unique Entries</p>
                    ...
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Sales Rate</p>
                    ...
                    <div className="text-center p-4 bg-purple-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Avg. Revenue per Ticket</p>
