                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="card-glass border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">1,189</h3>
                        ...
                        <form onSubmit={handleUpdateUser} className="space-y-4">
                            ...
                            <div className="flex space-x-3 pt-4">
                                <button
                                    ...
                                    className="flex-1 px-4 py-2 text-gray-700 bg-white dark:bg-secondary-900 border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-secondary-800"
                                >
                                    Cancel
                                </button>
                                <button
