        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                <nav className="text-sm text-gray-500 mb-2">
                    ...
                    <span className="text-gray-900 dark:text-white">Activity Logs</span>
                </nav>
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-secondary-900 rounded-lg shadow-lg border border-gray-200 dark:border-secondary-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                                <button
                                    onClick={() => handleExport('csv')}
                                    className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-secondary-800 rounded-t-lg"
                                >
                                    Export as CSV
                                </button>
                                <button
                                    onClick={() => handleExport('json')}
                                    className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-secondary-800 rounded-b-lg"
                                >
                                    Export as JSON
                                </button>
                            </div>
            ...
            {showStats && stats && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div className="card-glass border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{(stats.total_activities || 0).toLocaleString()}</p>
                            </div>
                    ...
                    <div className="card-glass border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Login Activities</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{(stats.login_activities || 0).toLocaleString()}</p>
                            </div>
                    ...
                    <div className="card-glass border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{(stats.security_activities || 0).toLocaleString()}</p>
                            </div>
                    ...
                    <div className="card-glass border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Admin Actions</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{(stats.admin_activities || 0).toLocaleString()}</p>
                            </div>
                ...
                {logs.length === 0 ? (
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-secondary-700">
                        {logs.map((log: ActivityLog) => (
                            <div key={log.id} className="p-6 bg-white dark:bg-secondary-800/50 hover:bg-gray-50 dark:hover:bg-secondary-800 transition-colors duration-200">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {log.causer && (
                                                    <div className="flex items-center space-x-2 mb-2">
                                                        ...
                                                        {log.causer.role && (
                                                            <span className="text-xs text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-secondary-800 px-2 py-0.5 rounded">
                                                ...
                                                {Object.keys(log.properties).length > 0 && (
                                                    <div className="mt-3 p-3 bg-gray-50 dark:bg-secondary-900/50 rounded-lg border border-gray-200 dark:border-secondary-700">
