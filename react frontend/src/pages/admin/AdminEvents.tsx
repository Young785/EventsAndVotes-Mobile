...
const AdminEvents: React.FC = () => {
    ...
    return (
        <div className="p-6">
                ...
                <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{pagination?.total || events.length}</p>
                        </div>
                    </div>
                </div>
            ...
            {/* Filters */}
            <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6 mb-6">
                                ...
                                <tr key={event.id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                <div className="text-sm font-medium text-gray-900 dark:text-white">{event.name || 'Untitled Event'}</div>
                                                <div className="text-sm text-gray-500 dark:text-gray-400">{event.description ? event.description.substring(0, 50) + '...' : 'No description'}</div>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div className="flex items-center justify-end space-x-2">
                                            ...
                                            <div className="relative dropdown-container">
                                                ...
                                                {openDropdown === event.id && (
                                                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-secondary-900 rounded-md shadow-lg z-[100] border border-gray-200 dark:border-secondary-700"
                                                ...
                                                Scan Tickets
                                                            ...
                                                            {event.status === 'draft' && (
                                                                <button
                                                                    ...
                                                                    className="flex items-center w-full px-4 py-2 text-sm text-green-700 hover:bg-gray-100 dark:bg-secondary-800"
                                                                >
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex items-center w-full px-4 py-2 text-sm text-red-700 hover:bg-gray-100 dark:bg-secondary-800"
                                                            >
