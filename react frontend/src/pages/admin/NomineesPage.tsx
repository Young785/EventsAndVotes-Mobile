        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                <nav className="text-sm text-gray-500 mb-2">
                    ...
                    <span className="mx-2">•</span>
                    <span className="text-gray-900 dark:text-white">Nominees</span>
                </nav>
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Voting Nominees</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Nominees</p>
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{nominees.length}</p>
                        </div>
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Male Nominees</p>
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Female Nominees</p>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-secondary-700">
                            ...
                            <tbody className="bg-white dark:bg-secondary-900 divide-y divide-gray-200 dark:divide-secondary-700">
                                {filteredNominees.map((nominee: any) => (
                                    <tr key={nominee.nominees_id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center space-x-2">
                                                <button
                                                    ...
                                                    className="p-2 text-gray-600 hover:text-gray-800 dark:text-gray-100"
                                                    title="Edit Nominee"
                                                >
