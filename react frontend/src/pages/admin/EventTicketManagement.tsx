    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Ticket Management & Analytics</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">of {stats.overview.total_capacity || 'unlimited'}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">Avg: {formatCurrency(stats.averageTicketPrice)}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.overview.total_scans}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">{stats.overview.attendance_rate.toFixed(1)}% rate</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.conversionRate.toFixed(1)}%</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Sales efficiency</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-secondary-700">
                        ...
                        <tbody className="bg-white dark:bg-secondary-900 divide-y divide-gray-200 dark:divide-secondary-700">
                            {analytics?.ticket_tiers?.map((tier) => (
                                <tr key={tier.name} className="hover:bg-gray-50 dark:bg-secondary-800">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div>
                                            <div className="text-sm font-medium text-gray-900 dark:text-white">{tier.name}</div>
                                            <div className="text-sm text-gray-500 dark:text-gray-400">Max {tier.max_per_user || 'unlimited'} per user</div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900 dark:text-white">{formatCurrency(tier.price)}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900 dark:text-white">{tier.capacity || 'Unlimited'}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900 dark:text-white">{tier.sold_count}</div>
            ...
            <div className="bg-white dark:bg-secondary-900 rounded-lg shadow overflow-hidden">
                <div className="p-6 border-b border-gray-200 dark:border-secondary-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Ticket Sales</h3>
                </div>
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-secondary-700">
                        <thead className="bg-gray-50 dark:bg-secondary-800">
                        ...
                        <tbody className="bg-white dark:bg-secondary-900 divide-y divide-gray-200 dark:divide-secondary-700">
                            {ticketsLoading ? (
                                ...
                                tickets.map((ticket: TicketData) => (
                                    <tr key={ticket.id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div>
                                                <div className="text-sm font-medium text-gray-900 dark:text-white">{ticket.customer_name}</div>
                                                <div className="text-sm text-gray-500 dark:text-gray-400">{ticket.customer_email}</div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900 dark:text-white">{ticket.tier_name}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm font-medium text-gray-900 dark:text-white">{formatCurrency(ticket.price_paid)}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="bg-white dark:bg-secondary-900 px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                        <div className="flex-1 flex justify-between sm:hidden">
                            <button
                                ...
                                className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white dark:bg-secondary-900 hover:bg-gray-50 disabled:opacity-50"
                            >
                                Previous
                            </button>
                            <button
                                ...
                                className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white dark:bg-secondary-900 hover:bg-gray-50 disabled:opacity-50"
                            >
                                Next
                            </button>
                        </div>
                            ...
                            <div>
                                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                    <button
                                        onClick={() => setCurrentPage(Math.max(1, currentPage - 1))}
                                        disabled={currentPage === 1}
                                        className="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white dark:bg-secondary-900 text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-50"
                                    >
                                        Previous
                                    </button>
                                    <button
                                        onClick={() => setCurrentPage(Math.min(pagination.last_page, currentPage + 1))}
                                        disabled={currentPage === pagination.last_page}
                                        className="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white dark:bg-secondary-900 text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-50"
                                    >
                                        Next
                                    </button>
                                </nav>
