        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                <nav className="text-sm text-gray-500 mb-2">
                    ...
                    <Link to="/admin/votes" className="hover:text-gray-700 dark:text-gray-300">Votes Management</Link>
                    <span className="mx-2">•</span>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Vote Transactions</h1>
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Voted(Not Voted)</p>
                                <p className="text-2xl font-bold text-green-600">
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Revenue After Charges</p>
                                <p className="text-2xl font-bold text-green-600" style={{ fontSize: '1rem' }}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                <button
                                    ...
                                    className="px-3 py-2 text-sm font-medium text-gray-500 bg-white dark:bg-secondary-900 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                                >
