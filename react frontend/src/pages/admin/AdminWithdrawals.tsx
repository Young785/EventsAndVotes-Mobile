        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-6">
                <nav className="text-sm text-gray-500 mb-2">
                    ...
                    <span className="text-gray-900 dark:text-white">Withdrawals</span>
                </nav>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">₦{stats.total_withdrawn.toLocaleString()}</h3>
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">₦{stats.pending_withdrawals.toLocaleString()}</h3>
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">₦{stats.processing_fees.toLocaleString()}</h3>
                ...
                <div className="card-glass border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">₦{stats.available_balance.toLocaleString()}</h3>
                                ...
                                <tr>
                                    <td colSpan={8} className="px-6 py-12 text-center">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="text-gray-500 dark:text-gray-400">You haven't made any withdrawal requests yet.</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
            ...
            {showDetailsModal && selectedWithdrawal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white dark:bg-secondary-900 rounded-lg shadow-xl max-w-lg w-full mx-4">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900 dark:text-white">{selectedWithdrawal.reference}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900 dark:text-white">₦{selectedWithdrawal.amount.toLocaleString()}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Amount Settled</label>
                                    <p className="text-sm text-gray-900 dark:text-white">₦{(selectedWithdrawal.amount_settled || selectedWithdrawal.amount * 0.95).toLocaleString()}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Processing Speed</label>
                                    <div className="mt-1">{selectedWithdrawal.pace ? getPaceBadge(selectedWithdrawal.pace) : 'N/A'}</div>
                                </div>
                            </div>

                            <div>
                                <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Bank Details</label>
                                <div className="mt-1 p-3 bg-gray-50 rounded-lg">
                                    <p className="text-sm text-gray-900 dark:text-white">{selectedWithdrawal.bank_account?.bank_name || 'N/A'}</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">{selectedWithdrawal.bank_account?.account_number || 'N/A'}</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">{selectedWithdrawal.bank_account?.account_name || 'N/A'}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Requested At</label>
                                    <p className="text-sm text-gray-900 dark:text-white">
