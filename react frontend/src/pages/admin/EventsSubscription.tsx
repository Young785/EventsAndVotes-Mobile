        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                <nav className="text-sm text-gray-500 mb-2">
                    ...
                    <span className="text-gray-900 dark:text-white">Events Subscription</span>
                </nav>
                <div className="flex items-center justify-between">
                    <div>
                        <div className="flex items-center space-x-3">
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Events Subscription</h1>
                    ...
                    <div className="card-glass border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{analytics.total_plans || 0}</p>
                            </div>
                    ...
                    <div className="card-glass border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">{analytics.active_subscriptions || 0}</p>
                            </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {plans.map((plan: EventSubscriptionPlan) => (
                                    <div key={plan.id} className={`bg-white dark:bg-secondary-900 rounded-lg shadow border-2 transition-all duration-200 hover:shadow-lg ${plan.is_popular ? 'border-blue-500' : 'border-gray-200'}`}>
                                        {plan.is_popular && (
                                            ...
                                            <div className="flex justify-between items-start mb-4">
                                                ...
                                                <div className="relative dropdown-container">
                                                    <button
                                                        ...
                                                        className="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 dark:bg-secondary-800"
                                                    >
            ...
            {pagination && pagination.last_page > 1 && (
                <div className="mt-6 card-glass border border-gray-200 px-6 py-4">
                    <div className="flex items-center justify-between">
...
const CreatePlanModal: React.FC<{ onClose: () => void; onSuccess: () => void }> = ({ onClose, onSuccess }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="card-glass p-6 w-full max-w-2xl max-h-screen overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Create Subscription Plan</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Price ({SettingsService.getCurrencySymbol()})</label>
                            <input
                                type="number"
                                step="0.01"
                                required
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Max Attendees per Event</label>
                            <input
                                type="number"
                                required
...
const EditPlanModal: React.FC<{
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="card-glass p-6 w-full max-w-2xl max-h-screen overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Edit Subscription Plan</h2>
                    <button onClick={onClose} className="text-gray-400 hover:text-gray-600 dark:text-gray-400">
                        <X className="w-6 h-6" />
                    </button>
                </div>
