                ...
                <>
                    ...
                    <div className="mb-6">
                        <nav className="text-sm text-gray-500 mb-2">
                            ...
                            <Link to="/admin/notifications" className="hover:text-gray-700 dark:text-gray-300">Notifications</Link>
                            <span className="mx-2">•</span>
                    ...
                    <div className="space-y-6">
                        {Object.entries(settings).map(([category, types]) => (
                            <div key={category} className="card-glass border border-gray-200 dark:border-secondary-700">
