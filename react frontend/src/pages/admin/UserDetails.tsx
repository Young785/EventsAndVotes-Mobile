            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Comprehensive user information and activities</p>
                    </div>
                </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{referral_info?.total_referrals || 0}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Referral Earnings</p>
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">₦{Number(referral_info?.total_earnings || 0).toLocaleString()}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{voting_statistics?.total_votes_cast || 0}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-white">{subscription_history?.total_subscriptions || 0}</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">₦{Number(financial_summary?.total_spent || 0).toLocaleString()}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Referral Earnings</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">₦{Number(financial_summary?.referral_earnings || 0).toLocaleString()}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Active Subscription</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">{subscription_history?.active_subscription ? 'Yes' : 'No'}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Events Participated</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">{event_activities?.total_events_participated || 0}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                {subscription_history?.subscription_history?.map((subscription: any, index: number) => (
                                    <div key={index} className="border border-gray-200 rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-3">
                                            <h4 className="font-medium text-gray-900 dark:text-white">{subscription.plan?.name || 'Unknown Plan'}</h4>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">{voting_statistics?.total_transactions || 0}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Successful Transactions</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">{voting_statistics?.successful_transactions || 0}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Failed Transactions</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">{voting_statistics?.failed_transactions || 0}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Spent on Voting</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">₦{Number(voting_statistics?.total_amount_spent || 0).toLocaleString()}</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {voting_statistics?.recent_transactions?.slice(0, 5).map((transaction: any, index: number) => (
                                            <div key={index} className="flex justify-between items-center p-2 text-sm border border-gray-200 rounded">
                                                <div>
                                                    <p className="font-medium text-gray-900 dark:text-white">{transaction.vote_name || 'Unknown Vote'}</p>
                                                    <p className="text-xs text-gray-500 dark:text-gray-400">{transaction.created_at ? new Date(transaction.created_at).toLocaleDateString() : 'Unknown Date'}</p>
                                                </div>
                        ...
                        <div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                                    ...
                                    <form onSubmit={(e) => {
                                        ...
                                        <div className="grid md:grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Total Referrals</label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Referral Earnings</label>
                                                <input
                                                    type="number"
                                                    step="0.01"
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">Registration Referrals</span>
                                            <span className="font-medium">{referral_info?.registration_referrals || 0}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">Subscription Referrals</span>
                                            <span className="font-medium">{referral_info?.subscription_referrals || 0}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">Vote Referrals</span>
                                            <span className="font-medium">{referral_info?.vote_referrals || 0}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">Event Referrals</span>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">User Registration</span>
                                            <span className="font-medium">{referral_info?.commission_rates?.user_registration || 0}%</span>
                                        </div>
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">Admin Registration</span>
                                        ...
                                        <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                            <span className="text-sm text-gray-600 dark:text-gray-400">Vote Purchase</span>
                            ...
                            <div className="space-y-3">
                                {referral_info?.recent_referrals?.map((referral: any, index: number) => (
                                    <div key={index} className="border border-gray-200 rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            <h5 className="font-medium text-gray-900 dark:text-white">{referral.referred_user_name || 'Unknown User'}</h5>
                                ...
                                {(!referral_info?.recent_referrals || referral_info.recent_referrals.length === 0) && (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">No referral history</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Voting Spent</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">₦{Number(financial_summary?.voting_spent || 0).toLocaleString()}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Subscription Spent</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">₦{Number(financial_summary?.subscription_spent || 0).toLocaleString()}</span>
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Event Spent</span>
                                            <span className="text-sm font-bold text-gray-900 dark:text-white">₦{Number(financial_summary?.event_spent || 0).toLocaleString()}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
