                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                ...
                                className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 px-3 py-1 rounded text-sm font-medium"
                            >
                                Mark as Read
                            </button>
                            <button
                                onClick={handleBulkDelete}
                                className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 px-3 py-1 rounded text-sm font-medium"
                            >
                                Delete
                            </button>
                        </div>
                ...
                {notifications.length === 0 ? (
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-secondary-700">
                        {notifications.map((notification: Notification) => (
                            <div
                                key={notification.id}
                                className={`p-6 bg-white dark:bg-secondary-800/50 hover:bg-gray-50 dark:hover:bg-secondary-800 transition-colors duration-200 border-l-4 ${notification.read_at ? 'opacity-75' : ''
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="flex items-center space-x-2 ml-4">
                                                ...
                                                <button className="p-2 text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-secondary-700 rounded-lg transition-colors duration-200">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                <button
                                    ...
                                    className="px-3 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 bg-white dark:bg-secondary-900 border border-gray-300 dark:border-secondary-700 rounded-lg hover:bg-gray-50 dark:hover:bg-secondary-800 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Previous
                                </button>
