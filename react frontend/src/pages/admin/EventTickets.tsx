    ...
    if (!event && !eventLoading) {
        return (
            <div className="p-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">The event you're looking for doesn't exist or you don't have permission to view it.</p>
        ...
        <div className="space-y-6 p-5">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-gray-900 dark:text-white">{event?.title || 'Event Tickets'}</span>
                    </div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Ticket Management</h1>
                    <p className="text-gray-600 dark:text-gray-400">Monitor and manage tickets for {event?.title}</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-semibold text-gray-900 dark:text-white">{stats.totalTicketsSold.toLocaleString()}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-semibold text-gray-900 dark:text-white">{stats.totalCapacity.toLocaleString()}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="card-glass p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Sales Rate</p>
                            <p className="text-2xl font-semibold text-gray-900 dark:text-white">{stats.salesRate.toFixed(1)}%</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="card-glass p-6">
                ...
                {event?.ticketTiers && event.ticketTiers.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">No ticket tiers configured for this event</p>
                    </div>
                )}
            </div>
            ...
            <div className="card-glass">
                <div className="p-6 border-b border-gray-200 dark:border-secondary-700">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Ticket Purchases</h2>
                </div>
                                    ...
                                    <tr key={ticket.id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <div className="text-sm text-gray-900 dark:text-white">{ticket.customer_name}</div>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900 dark:text-white">{ticket.ticket_tier?.name || 'N/A'}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm font-medium text-gray-900 dark:text-white">${ticket.price}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
