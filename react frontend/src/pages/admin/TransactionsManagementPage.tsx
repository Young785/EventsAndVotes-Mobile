            ...
            <AdminLayout>
                <div className="flex items-center justify-center min-h-screen">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">This page is only accessible to Admin and SuperAdmin users.</p>
                    </div>
                </div>
            </AdminLayout>
        )
            ...
            <div className="p-6">
                ...
                <div className="mb-6">
                    <nav className="text-sm text-gray-500 mb-2">
                        ...
                        <span className="text-gray-900 dark:text-white">Transactions Management</span>
                    </nav>
                    ...
                    <div className="space-y-6 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="card-glass border border-gray-200 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Failed/Pending</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="card-glass border border-gray-200 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Votes Bought</p>
                            ...
                            <div className="card-glass border border-gray-200 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Gateway Fees</p>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {transactionsResponse.statistics.revenue_by_gateway.map((gateway: any, index: number) => (
                                            <div key={index} className="bg-gray-50 rounded-lg p-4">
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{gateway.gateway}</p>
                                                        <p className="text-lg font-bold text-gray-900 dark:text-white">
                                                            ₦{gateway.revenue.toLocaleString()}
                                                        </p>
                                                        <p className="text-xs text-gray-500 dark:text-gray-400">{gateway.count} transactions</p>
                                                    </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-secondary-700">
                                ...
                                <tbody className="bg-white dark:bg-secondary-900 divide-y divide-gray-200 dark:divide-secondary-700">
                                    {transactions.map((transaction: any) => (
                                        <tr key={transaction.transaction_id} className="hover:bg-gray-50 dark:bg-secondary-800">
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-900 dark:text-white">{selectedTransaction.transaction_id}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Reference</label>
                                            <p className="text-sm text-gray-900 dark:text-white">{selectedTransaction.trxref || 'No reference'}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-900 dark:text-white">₦{(selectedTransaction.amount_paid || 0).toLocaleString()}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Gateway Fee</label>
                                            <p className="text-sm text-gray-900 dark:text-white">₦{(selectedTransaction.gateway_fee || 0).toLocaleString()}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Votes Count</label>
                                            <p className="text-sm text-gray-900 dark:text-white">{selectedTransaction.votes_count || 0}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 dark:text-gray-400">IP Address</label>
                                            <p className="text-sm text-gray-900 dark:text-white">{selectedTransaction.ip_address || 'N/A'}</p>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Channel</label>
                                            <p className="text-sm text-gray-900 dark:text-white">{selectedTransaction.channel || 'N/A'}</p>
                                        </div>
                                    </div>

                                    {selectedTransaction.gateway_response && (
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Gateway Response</label>
