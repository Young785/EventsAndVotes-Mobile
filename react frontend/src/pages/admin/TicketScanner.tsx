    ...
    if (!event && !isLoading) {
        return (
            <div className="p-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">The event you're looking for doesn't exist or you don't have permission to scan tickets for it.</p>
            ...
            <div className="flex items-center justify-between">
                <div>
                    <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-gray-400">/</span>
                        <span className="text-gray-900 dark:text-white">Scanner</span>
                    </div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Ticket Scanner</h1>
                    <p className="text-gray-600 dark:text-gray-400">Scan and validate tickets for {event?.title}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="card-glass p-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Valid Scans</p>
                    ...
                    <div className="card-glass p-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Invalid Scans</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">0</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card-glass p-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Re-entries</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white">0</p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="card-glass p-6">
                ...
                {scanHistory.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">Start scanning tickets to see history here</p>
                    </div>
                )}
            </div>
