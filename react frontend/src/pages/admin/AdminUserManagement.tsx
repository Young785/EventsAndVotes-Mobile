    ...
    return (
        <div className="p-6">
            ...
            {usersLoading ? (
                ...
                <>
                    {/* Users Table - Desktop */}
                    <div className="hidden lg:block card-glass border border-gray-200 overflow-hidden">
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-secondary-700">
                                ...
                                <tbody className="bg-white dark:bg-secondary-900 divide-y divide-gray-200 dark:divide-secondary-700">
                                    {usersData?.data.map((userData: any) => (
                                        <tr key={userData.id} className="hover:bg-gray-50 dark:bg-secondary-800">
                    ...
                    <div className="lg:hidden space-y-4">
                        {usersData?.data.map((userData: any) => (
                            <div key={userData.id} className="card-glass border border-gray-200 p-4">
                        ...
                        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                            ...
                            <div className="flex items-center space-x-2">
                                <button
                                    ...
                                    className="p-2 text-gray-500 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg hover:bg-gray-100 dark:bg-secondary-800"
                                >
