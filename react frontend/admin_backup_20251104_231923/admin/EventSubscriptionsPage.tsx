            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <nav className="text-sm text-gray-500 mb-4">
                        ...
                        <span className="text-gray-900">Event Subscriptions</span>
                    </nav>
...
{/* Transaction Table */ }
{
    transactionsLoading ? (
        ...
        <div className="p-6 text-center">
            ...
            <p className="text-gray-500">Failed to load subscription transactions. Please try again.</p>
        </div>
            ...
            <table className="min-w-full">
                <thead>
                    <tr className="border-b border-gray-100">
                        ...
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Plan Details</th>
                    ...
                    {plansLoading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {plans.map((plan: any) => (
                                <div
                                    key={plan.id}
                                    className={`relative bg-white rounded-2xl border-2 transition-all duration-300 hover:scale-105 hover:shadow-xl ${plan.is_popular
                                ...
                                >
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="text-center mb-8">
                                            ...
                                            <p className="text-gray-600">for {plan.duration_days} days</p>
                                        </div>
