                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{statsData.total_transactions?.toLocaleString()}</p>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">₦{statsData.total_revenue?.toLocaleString()}</p>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">₦{statsData.pending_amount?.toLocaleString()}</p>
                                    <p className="text-sm text-gray-500">{statsData.pending_count} transactions</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{statsData.success_rate}%</p>
                                    <p className="text-sm text-gray-500">{statsData.successful_transactions} successful</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {transactions.map((transaction: any) => (
                                    <tr key={transaction.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">{transaction.user_name || 'Anonymous'}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm font-medium text-gray-900">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">{selectedTransaction.user_name || 'Anonymous'}</p>
                                </div>
                                <div>
                            ...
                            {selectedTransaction.vote_name && (
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">{selectedTransaction.vote_name}</p>
                                </div>
                            )}
                            ...
                            {selectedTransaction.subscription_plan && (
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">{selectedTransaction.subscription_plan}</p>
                                </div>
                            )}
                        </div>
                    </div>
