            ...
            {showStatsPanel && subscriptionData && (
                <>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-600">Total Spent</p>
                                    <p className="text-2xl font-bold text-gray-900">₦{parseFloat(subscriptionData.subs.all).toLocaleString()}</p>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-gray-600">Vote Categories</p>
                                    <p className="text-2xl font-bold text-gray-900">{subscriptionData.voting.category}</p>
                                <p className="text-xs text-gray-500 mt-1">
                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{subscriptionData.voting.nominees}</p>
                                    <p className="text-xs text-gray-500 mt-1">
                                        Available
                                </p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{subscriptionData.left.total}</p>
                                <p className="text-xs text-gray-500 mt-1">
