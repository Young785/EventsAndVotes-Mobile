                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">{selectedRequest.user_email}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">User Name</label>
                                    <p className="text-sm text-gray-900">{selectedRequest.user_name || 'N/A'}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">{selectedRequest.plan_name}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">Plan Price</label>
                                    <p className="text-sm text-gray-900">₦{selectedRequest.plan_price?.toLocaleString()}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">{selectedRequest.bank_name}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">Depositor Name</label>
                                    <p className="text-sm text-gray-900">{selectedRequest.depositor_name}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">Amount Paid</label>
                                    <p className="text-sm text-gray-900">₦{parseFloat(selectedRequest.amount).toLocaleString()}</p>
                                </div>
                                <div>
                                    ...
                                    <div className="border rounded-lg p-4">
                                        <img
                                            ...
                                            onError={(e) => {
                                                ...
                                                if (parent) {
                                                    parent.innerHTML = '<div class="flex items-center justify-center p-8 text-gray-500"><FileText class="w-8 h-8 mr-2" /><span>Receipt file</span></div>';
                                                }
                                            }}
                                        />
                                        <a
