            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">Update your event details and ticket tiers</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                            />
                            <p className="mt-1 text-sm text-gray-500">JPG, PNG, GIF up to 2MB. Leave empty to keep current image.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded"
                            />
                            <label htmlFor="re_entry_allowed" className="ml-2 block text-sm text-gray-700">
                                Allow re-entry
                            </label>
                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            className="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded"
                                        />
                                        <label htmlFor={`tier_active_${index}`} className="ml-2 block text-sm text-gray-700">
                                            Active
                                        </label>
                                    </div>
                                </div>
